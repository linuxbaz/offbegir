...
function page_loader(idmain,page)
{
	...
	$("#blog_section").load("pagination_blog.php?page="+page+"&idmain="+idmain, Hide_Load());
	 $("#loading").fadeIn(300,0);
	window.scrollTo(0, 0);
...
{
		$("#blog_section").fadeIn(300,0);
	$("#blog_section").load("pagination_blog.php?page="+page+"&q="+q, Hide_Load());
...
//document.getElementById("title_content").innerHTML = print_title();
	...
	if(q != 0)
	{
		...
		$("#blog_section").load("pagination_blog_search.php?page="+page+"&q="+q, Hide_Load());
	}
	else
	{
		$("#blog_section").load("pagination_blog.php?page="+page+"&idmain=0", Hide_Load());
...
<body >
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/blogs/blog_travel.jpg);">
